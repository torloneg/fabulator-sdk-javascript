...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabulatorApi.Model14();
  });
  ...
  describe('Model14', function() {
    it('should create an instance of Model14', function() {
      // uncomment below and update the code to test Model14
      //var instance = new FabulatorApi.Model14();
      //expect(instance).to.be.a(FabulatorApi.Model14);
    });
