...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabulatorApi.Model11();
  });
  ...
  describe('Model11', function() {
    it('should create an instance of Model11', function() {
      // uncomment below and update the code to test Model11
      //var instance = new FabulatorApi.Model11();
      //expect(instance).to.be.a(FabulatorApi.Model11);
    });
