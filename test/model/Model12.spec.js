...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabulatorApi.Model12();
  });
  ...
  describe('Model12', function() {
    it('should create an instance of Model12', function() {
      // uncomment below and update the code to test Model12
      //var instance = new FabulatorApi.Model12();
      //expect(instance).to.be.a(FabulatorApi.Model12);
    });
