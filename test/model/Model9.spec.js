...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabulatorApi.Model9();
  });
  ...
  describe('Model9', function() {
    it('should create an instance of Model9', function() {
      // uncomment below and update the code to test Model9
      //var instance = new FabulatorApi.Model9();
      //expect(instance).to.be.a(FabulatorApi.Model9);
    });
